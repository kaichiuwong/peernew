...
class Assignment_topic_model extends CI_Model
{
    ...
    /*
     * Get assignment_topic by assignment id
     */
    ...
    /*
     * function to add new assignment_topic
     */
    ...
    /*
     * function to update assignment_topic
     */
    ...
    /*
     * function to delete assignment_topic
     */
    ...
    {
        $query = $this->db->query("select * from sv_assignment_topic_member where topic_id=$id order by sid; ");
        return $query->result_array();
    }
