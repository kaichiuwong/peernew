...
<div class="card card-secondary">
    ...
    <?php echo form_open('Assignment_date/edit/'.$asg_id.'/'.$Assignment_date['id'],array("class"=>"form-horizontal")); ?>
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="topic" class="col-md-4 control-label">Date Value</label>
