  ...
  <div class="col-12">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title"><span class="badge badge-primary">Part A</span> Submission</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title"><span class="badge badge-primary">Part B</span>Self Evaluation Questions</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title"><span class="badge badge-primary">Part C</span>Peer Review</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
