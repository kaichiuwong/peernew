...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">Create Extra Unit Groups for <?php echo $set_info['desc']; ?></h3>
    </div>
    <?php echo form_open('Unit_group/add_group/'.$unit_id.'/'.$set_id,array("class"=>"form-horizontal")); ?>
    <div class="card-body">
    ...
    <div class="card-footer">
        ...
        <a href="<?php echo site_url('Unit_group/group/'.$unit_id.'/'.$set_id); ?>" class="btn btn-sm btn-secondary">Cancel</a>
    </div>
    <?php echo form_close(); ?>
</div>